...
<body>
   ...
   <section class="courses">
      <h1 class="heading">Complete The Word</h1>
      <div class="box-container">
         ...
         <div class="box" style="background-color: none;">
            ...
            <a href="completetheword/buah" class="inline-btn">Play Game</a>
         </div>
         <div class="box" style="background-color: none;">
            <div class="thumb">
            ...
            <a href="completetheword/hewan" class="inline-btn">Play Game</a>
         </div>
         <div class="box" style="background-color: none;">
            <div class="thumb">
            ...
            <a href="completetheword/benda" class="inline-btn">Play Game</a>
         </div>
      </div>
